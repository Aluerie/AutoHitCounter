...
public static class VersionChecker
{
    public static async Task<(bool hasUpdate, Version currentVersion, Version webVersion)> CheckForUpdate()
    {
        try
        {
            ...
            client.DefaultRequestHeaders.UserAgent.Add(
                new ProductInfoHeaderValue("AutoHitCounter", currentVersion.ToString()));

            var response = await client.GetStringAsync(
                "https://api.github.com/repos/borgCode/AutoHitCounter/releases/latest");
    ...
    public static async void CheckForUpdates(Window parentWindow, bool showNoUpdateMessage = false)
    {
        ...
        downloadButton.Click += (s, e) =>
        {
            ...
            {
                FileName = "https://github.com/borgCode/AutoHitCounter/releases/latest",
